...
const MaintenanceServices = () => {
  ...
  const services = [
    ...
    {
      icon: <Maximize2 className="size-8 text-green-700" />,
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">
              Maximize Your Solar Investment with Professional Maintenance
            </h2>
            <p className="mx-auto max-w-3xl text-lg text-gray-700">
              Regular maintenance is crucial for your solar system's longevity
              and performance. In Kenya's unique climate, proper upkeep can
              increase system efficiency by up to 25%, reduce unexpected
              breakdowns, and save you money in the long run. Our comprehensive
              maintenance services ensure your system operates at peak
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <div
                key={index}
                className="cursor-pointer rounded-lg border border-transparent bg-[#ecf4f0] p-6 transition-all duration-300 hover:border-amber-200 hover:shadow-xl"
                onClick={() =>
